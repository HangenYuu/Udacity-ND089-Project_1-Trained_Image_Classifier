...
#            pct_correct_notdogs - percentage of correctly classified NON-dogs
#
    results_stats_dic = {'n_images': 0, 'n_dogs_img': 0, 'n_notdogs_img': 0, 'n_match': 0, 'n_correct_dogs': 0, 'n_correct_notdogs': 0, 'n_correct_breed': 0}
    results_stats_dic['n_images'] = len(results_dic)
    for item in results_dic:
        if results_dic[item][2] == 1:
            results_stats_dic['n_match'] += 1
         
        if results_dic[item][3] == 1:
    ...
    results_stats_dic['pct_correct_breed'] = results_stats_dic['n_correct_breed']/results_stats_dic['n_correct_dogs']*100
